...
if YOLO_variant == "yolov11l":
    ...
    model = YOLO("./yolov8l_model/helmet_base_yolo8l_best.pt") #YOLOv8 large model
elif YOLO_variant == "custom_yolov11l":
    model = YOLO("./demonstration/full_custom_trained_yolov11.pt") #YOLOv8 large model
elif YOLO_variant == "custom_yolov8l":
    model = YOLO("./demonstration/full_trained_custom_model_yolov8l.pt") #YOLOv8 large model
